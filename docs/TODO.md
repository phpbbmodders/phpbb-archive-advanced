...
- **Attachment file-type icons**: use Bootstrap Icons (decided) — attachment badges are still plain CSS text badges (see "Attachment-type badges" in `docs/CHANGES.md`). Next up.
